...
class QRScannerController: UIViewController {
    ...
    lazy var qrAlertNetworkStatusManager: BulletinManager = {
...
//            captureMetadataOutput.metadataObjectTypes = [AVMetadataObject.ObjectType.qr]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "detailQR" {
            if let destCtrl = segue.destination as? DetailQRViewController {
                if let decodeURL = sender as? String {
                    destCtrl.decodeURL = decodeURL
                }
            }
        }
    }
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            if metadataObj.stringValue != nil {
                ...
                self.performSegue(withIdentifier: "detailQR", sender: metadataObj.stringValue!)
